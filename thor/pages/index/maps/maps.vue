<template>
	<view class="maps-container">
			...
			<view class="search-bar-form">
				<view class="search-bar-box">
					...
					<input confirm-type="search" class="search-bar-input" placeholder="请输入您的目的地" :value="inputVal"
						:focus="inputShowed" @confirm="bindInput" @input="inputTyping" />
		...
		<scroll-view scroll-y class="scrollView" :style="{height:scrollH +'px'}" @scrolltolower="pullUp" @touchstart="onTouchStart" @touchend="onTouchEnd">
			<view class="tui-list">
				<view class="tui-list-cell" :class="[index==address.length-1?'tui-cell-last':'']"
					...
					<view class="addr-box ">
						...
						<view class="addr-opera">
							<view class="opera-box" hover-class="tui-opcity" :hover-stay-time="150" @tap="go"
								:data-id="item.id">
